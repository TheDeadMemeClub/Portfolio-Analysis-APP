...
st.set_page_config(page_title="Investment Analysis App v10", page_icon="📈", layout="wide")
...
st.markdown(
    '<div class="subtle">Improves valuation data extraction with better TTM EPS and dividend fallbacks so fields like P/E and dividend rate populate more reliably.</div>',
    unsafe_allow_html=True
)
