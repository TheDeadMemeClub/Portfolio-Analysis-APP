...
st.set_page_config(page_title="Investment Analysis App v8", page_icon="📈", layout="wide")
...
st.markdown(
    '<div class="subtle">More robust Yahoo data handling, fixed fundamentals fallback logic, and stronger valuation inputs across more tickers.</div>',
    unsafe_allow_html=True
)
